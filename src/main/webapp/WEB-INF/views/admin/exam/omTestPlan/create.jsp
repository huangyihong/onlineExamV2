...
<form class="layui-form layui-form-pane" action="" id="form">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            <label class="layui-form-label"><span class="c-red">*</span>练习试卷：</label>
        ...
        <div class="layui-inline">
            <label class="layui-form-label"><span class="c-red">*</span>练习名称：</label>
            <div class="layui-input-inline">
        ...
        <input type="hidden" id="autoMarkFlag" name="autoMarkFlag" value="1"/>
        <%-- <div class="layui-inline">
...
<script type="text/javascript" src="${contextPath }/static/js/admin/exam/omTestPlan/create.js"></script>
