...
<form class="layui-form layui-form-pane" action="" id="form">
    ...
    <input type="hidden" id="courseId" name="courseId" value="${bean.courseId}"/>
    <br>
    <div class="layui-form-item">
        <div class="layui-inline">
            <label class="layui-form-label"><span class="c-red">*</span>科目名称：</label>
            <div class="layui-input-inline">
                <input type="text" id="courseName" name="courseName" autocomplete="off" class="layui-input" lay-verify="required|maxlength" value="${bean.courseName }">
            </div>
        </div>    
   </div>     
...
<script type="text/javascript" src="${contextPath }/static/js/admin/exam/omCourse/create.js"></script>
