...
<form class="layui-form layui-form-pane" action="" id="form">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="optionA" autocomplete="off" class="layui-input" value="${bean.optionA }">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="optionB" autocomplete="off" class="layui-input" value="${bean.optionB }">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="optionC" autocomplete="off" class="layui-input" value="${bean.optionC }">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="optionD" autocomplete="off" class="layui-input" value="${bean.optionD }">
            </div>
        </div>
    </div> 
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="radio" name="rightResult" value="A" title="A" <c:if test="${bean.rightResult=='A' }">checked</c:if>>
                <input type="radio" name="rightResult" value="B" title="B" <c:if test="${bean.rightResult=='B' }">checked</c:if>>
                <input type="radio" name="rightResult" value="C" title="C" <c:if test="${bean.rightResult=='C' }">checked</c:if>>
                <input type="radio" name="rightResult" value="D" title="D" <c:if test="${bean.rightResult=='D' }">checked</c:if>>
                <input type="radio" name="rightResult" value="E" title="E" <c:if test="${bean.rightResult=='E' }">checked</c:if>>
                <input type="radio" name="rightResult" value="F" title="F" <c:if test="${bean.rightResult=='F' }">checked</c:if>>
                <input type="radio" name="rightResult" value="G" title="G" <c:if test="${bean.rightResult=='G' }">checked</c:if>>
                <input type="radio" name="rightResult" value="H" title="H" <c:if test="${bean.rightResult=='H' }">checked</c:if>>
            </div>
        </div>
     </div>
     <div class="layui-form-item">
