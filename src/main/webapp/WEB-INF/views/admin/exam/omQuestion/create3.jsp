...
<form class="layui-form layui-form-pane" action="" id="form">
   ...
   <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-inline">
            <input type="radio" name="rightResult" value="1" title="正确" <c:if test="${bean.rightResult=='1' }">checked</c:if>>
            <input type="radio" name="rightResult" value="0" title="错误" <c:if test="${bean.rightResult=='0' }">checked</c:if>>
        </div>
    </div>
