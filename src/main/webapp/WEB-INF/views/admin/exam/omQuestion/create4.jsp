...
<form class="layui-form layui-form-pane" action="" id="form">
   ...
   <div class="layui-form-item layui-form-text">
    <label class="layui-form-label" style="width: 90%!important;"><span class="c-red">*</span>题目(在需填空的位置点击插入空格,插入(____)代表填空)：</label>
    <div class="layui-input-inline" style="width: 90%!important;">
      <textarea name="questionName" id="questionName" class="layui-textarea" lay-verify="required" placeholder="请输入题目内容">${bean.questionName }</textarea>
    </div>
  </div>
  <div class="layui-form-item">
  	 <button type="button" class="layui-btn layui-btn-radius layui-btn-sm m-l-20"  onclick="insertBlank(this)">插入空格</button>
  </div>
  <div class="layui-form-item layui-form-text">
    <label class="layui-form-label" style="width: 90%!important;"><span class="c-red">*</span>标准答案(多个填空答案用、号分割,多组答案可用||分割)：</label>
    <div class="layui-input-inline" style="width: 90%!important;">
  ...
  <div class="layui-form-item">  
    <div class="layui-inline">
        <label class="layui-form-label">答案顺序固定：</label>
        <div class="layui-input-inline">
        	<select  name="isArtificial" value="${bean.isArtificial }">
              	<option value="1" <c:if test="${bean.isArtificial == '1' }">selected</c:if>>是</option>
              	<option value="0" <c:if test="${bean.isArtificial == '0' }">selected</c:if>>否</option>
            </select>
        </div>
    </div>
  </div>
