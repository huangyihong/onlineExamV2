...
<div class="layui-card-header" style="text-align: center;">
         ...
         <c:if test="${type!='monitorExam' }">
         	<p class="layadmin-font-em">总分：${bean.paperScore }<span class="p-l-50"></span>考试时长(分)：<span id="examTime">${bean.paperTime }</span></p>
	         <p>姓名： <u> &emsp;${examSubmit.realName} &emsp;</u>
...
<div class="layui-form-item" style="text-align: center">
    <span>
        <c:if test="${examSubmit.status=='3' }">
        <a onclick="gradeExam('${examSubmit.submitId }','4')"
           class="fm-button ui-state-default ui-corner-all fm-button-icon-left ui-reset btn btn-sm btn-default">成绩发布</a>
        </c:if>   
...
<script type="text/javascript" src="${contextPath }/static/js/admin/exam/omPaper/markExam.js?v=<%=Math.random()%>"></script>
