        ...
        <div class="operation-content margin-center p-t-10" id="tableTool">
            <div class="layui-btn-group">
                <button class="layui-btn layui-btn-primary layui-btn-sm" data-type="add">
                    <i class="iconfont iconxinzeng t-grey-999 " title="新增" ></i> 新增固定试卷
                </button>
                <button class="layui-btn layui-btn-primary layui-btn-sm" onclick="addAuto()">
                    <i class="iconfont iconxinzeng t-grey-999 " title="新增" ></i> 新增随机试卷
                </button>
                ...
                <button class="layui-btn layui-btn-primary layui-btn-sm" data-type="updateAdd">
                    <i class="iconfont iconxinzeng t-grey-999 " title="新增" ></i> 复制新增
                </button>
                
                <button class="layui-btn layui-btn-primary layui-btn-sm" onclick="exportPaper()">
                    <i class="iconfont">&#xe651;</i> 导出word试卷
                </button>
...
<script type="text/javascript" src="${contextPath }/static/js/admin/exam/omPaper/list.js"></script>
