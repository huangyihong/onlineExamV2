...
<form class="layui-form layui-form-pane" action="${contextPath}/admin/system/omUser/uploadBatchUserImg" enctype="multipart/form-data" id="form">
	<br>	
		...
		<div class="layui-inline">
			...
			<div class="layui-input-inline">
				<button type="button" class="layui-btn" id="importBtn">
				  <i class="layui-icon">&#xe67c;</i>导入图片压缩文件(.zip)
				</button>
			</div>
		</div>
  	</div>
...
layui.use('upload', function(){
	  ...
	  var uploadInst = upload.render({
	    ...
	    ,url: WEBROOT + '/admin/system/omUser/uploadBatchUserImg' //上传接口
	    ,accept: 'file' //普通文件
	    ,exts: 'zip' //允许上传的文件后缀
	    ,size: 10240 //最大10MB
    	,before: function(obj){ 
