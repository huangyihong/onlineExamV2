    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="userName" id="userName" autocomplete="off" class="layui-input" lay-verify="required|username|maxlength" value="${bean.userName }"
	                <c:if test="${fntype!='add' }">
	                	readonly
	                </c:if>
                >
            </div>
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <select name="idType" value="${bean.idType }" lay-verify="required">
        ...
        <br>
        <div class="layui-inline">
            <label class="layui-form-label"><span class="c-red">*</span>登录密码：</label>
            <div class="layui-input-inline">
                <input type="text" name="password" autocomplete="off" class="layui-input" lay-verify="required|pass" value="123456">
            </div>
        </div>
        <div class="layui-inline">
                                  默认: 123456
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
	           <select id="userType" name="userType" lay-verify="required" lay-filter="userType" value="${bean.userType }">
	           		<c:if test="${empty userType }">
	           		<option value="1"  <c:if test="${bean.userType == '1' }">selected</c:if>>管理员</option>
	                <option value="2"  <c:if test="${bean.userType == '2' }">selected</c:if>>教练</option>
	           		</c:if>
	                <option value="3"  <c:if test="${bean.userType == '3' }">selected</c:if>>学员</option>
                </select>
            </div>
        </div>
        <div class="layui-inline">
