         ...
         <div class="right-search" id="tableQuery">
             <div class="layui-row">
                 <div class="layui-col-xs6 layui-col-sm6 layui-col-md4">
                     <ol class="layui-row">
                         <dt class="layui-col-md4 ellipsis">角色编码</dt>
                 ...
                 <div class="layui-col-xs6 layui-col-sm6 layui-col-md4">
                     <ol class="layui-row">
                         <dt class="layui-col-md4 ellipsis">角色名称</dt>
                         <dd class="layui-col-md8">
    ...
    <div class="layui-card-body">
        ...
        <div class="operation-content margin-center p-t-10" id="tableTool">
            <div class="layui-btn-group">
                ...
                <button class="layui-btn layui-btn-primary layui-btn-sm" onclick="assignMenu()">
                    	 <i class="iconfont">&#xe60a;</i> 菜单授权	
                </button>
                
                <button class="layui-btn layui-btn-primary layui-btn-sm" onclick="assignUser()">
                    	 <i class="iconfont">&#xe60a;</i> 用户授权	
                </button>
            </div>
        </div>
        <!--操作 end-->
...
<script type="text/javascript" src="${contextPath }/static/js/admin/system/omRole/list.js"></script>
