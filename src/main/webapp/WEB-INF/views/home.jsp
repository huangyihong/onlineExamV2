...
<link rel="stylesheet" href="${contextPath }/static/css/home.css" type="text/css" />
<script type="text/javascript" src="${contextPath }/static/js/jquery-3.2.1.min.js"></script>
<script type="text/javascript" src="${contextPath }/static/js/content.js"></script>
...
<body bgcolor="#F4F4F4">
	<div class="head">
		...
		<div class="logout_button">
			...
			<a href="${contextPath}/admin/logout"><i class="iconfont icondingbudaohang-zhangh" ></i> 退 出</a> 
		</div>
	</div>
